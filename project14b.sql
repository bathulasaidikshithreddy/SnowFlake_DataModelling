create or replace warehouse p14b_wh
with 
...
create or replace database p14b_db;
use database p14b_db;

create or replace schema p14b_schema;

create or replace stage p14b_stage;
...
SHOW TABLES LIKE 'SILVER_CLEANED_TRANSACTIONS';
